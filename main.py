...
selection_1 = Spinbox(option_frame, values=("Turn left", "Turn right"))
...
selection_2 = Spinbox(option_frame, values=("Don't include color", "Turn left", "Turn right"))
...
selection_3 = Spinbox(option_frame, values=("Don't include color", "Turn left", "Turn right"))
...
selection_4 = Spinbox(option_frame, values=("Don't include color", "Turn left", "Turn right"))
...
selection_5 = Spinbox(option_frame, values=("Don't include color", "Turn left", "Turn right"))
...
selection_6 = Spinbox(option_frame, values=("Don't include color", "Turn left", "Turn right"))
